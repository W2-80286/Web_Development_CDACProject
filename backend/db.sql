...
CREATE TABLE user (
    ...
    phone VARCHAR(50), -- Changed the data type to INT(15) to accommodate 15 digits
    role VARCHAR(50), -- Added the role column
...
CREATE TABLE bookingDetails (
    ...
    payment_status ENUM('paid', 'unpaid') DEFAULT 'unpaid', -- New column for payment status
